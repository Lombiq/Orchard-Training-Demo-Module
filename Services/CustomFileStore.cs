...
// You have multiple ways to use the FileSystemStore service. The one demonstrated here is to simply inherit our service
// from the FileSystemStore. And also inherit our service from IFileStore. The other way is to "decorate" the IFileStore
// which means that it will be an injected service inside our implementation. Find MediaFileStore.cs to see how that way
// is done.
