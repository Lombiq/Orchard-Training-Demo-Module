/*
 * This class will add some commands to the Orchard command line (http://docs.orchardcore.net/projects/O1/en/latest/Documentation/Using-the-command-line-interface/).
 * 
