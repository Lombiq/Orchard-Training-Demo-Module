...
using static Lombiq.TrainingDemo.GraphQL.Services.PersonPartQueryObjectType;

namespace Lombiq.TrainingDemo.GraphQL.Services
{
    public class PersonPartWhereObjectType : WhereInputObjectGraphType<PersonPart>
    {
        ...
        public PersonPartWhereObjectType() =>
