namespace Lombiq.TrainingDemo.Settings
{
    ...
    // ColorField these settings will be applied on every content item where the PersonPart is in present, however, if
    // you have multiple ColorFields, each fields will have their own settings. In our case we have three settings.
    ...
    // PersonPart). If you attach the field on the dashboard yourself then Orchard Core will display its editor.
    // Editor of an object like this? You know what you need to do... Create a DisplayDriver for this!
